 ...
 */
public class BchxDialog extends Dialog {
    ...
    public BchxDialog(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bchx_dialog_layout);
        //按空白处不能取消动画
...
//        titleTv = (TextView) findViewById(R.id.title);
        ...
        et_name = (EditText) findViewById(R.id.bchx_et_name);
