...
import com.yisipu.chartmap.adapter.DhhxtAdapter;
 ...
 */
public class DhxhPointDialog extends Dialog {
...
//    CoursePointAdapter coursePointAdapter;
    ...
    public DhxhPointDialog(Context context, List<String> ls) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dh_xh_dialog, null);
        setContentView(view);
        //按空白处不能取消动画
...
//                coursePointAdapter = new CoursePointAdapter(context, points, name, this);
                dhPointAdapter = new DhhxtAdapter(context, hxlist);
...
//        yes = (Button) view.findViewById(R.id.yes);
        fh = (ImageView) view.findViewById(R.id.dh_hx_dialog_close);
//        titleTv = (TextView) view.findViewById(R.id.title);
//
//        et_name = (EditText) view.findViewById(R.id.et_name);
        ls7 = (ListView) view.findViewById(R.id.dh_ls_hx);
