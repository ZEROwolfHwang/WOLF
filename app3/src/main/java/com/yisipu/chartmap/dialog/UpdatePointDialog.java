 ...
 */
public class UpdatePointDialog extends Dialog {
    ...
    public UpdatePointDialog(Context context,String name,String jd,
    String wd,int position) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.update_point_dialog, null);
    ...
    private void initData() {
        ...
        et_wd.setText(wd);
        if(getPosition()==-1){
            iv_tubiao.setBackgroundResource(Constant.hdImage[0]);
            position=0;
        }else {
            iv_tubiao.setBackgroundResource(Constant.hdImage[getPosition()]);
        }
