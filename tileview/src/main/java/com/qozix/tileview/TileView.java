...
public class TileView extends ZoomPanLayout implements
  ...
  public View addMarker2( View view, double x, double y, Float anchorX, Float anchorY,int width,int height ) {
    return mMarkerLayout.addMarker2( view,
            mCoordinateTranslater.translateX( x ),
            mCoordinateTranslater.translateY( y ),
  ...
  public CompositePathView.DrawablePath drawPath2( List<double[]> positions, Paint paint ) {
    Path path = mCoordinateTranslater.pathFromPositions2( positions,false );
    return mCompositePathView.addPath( path, paint );
  }

  public CompositePathView.DrawablePath drawPath3( List<double[]> positions, Paint paint ) {
    Path path = mCoordinateTranslater.pathFromPositions3( positions,false );
    return mCompositePathView.addPath( path, paint );
  }
  /**
  ...
  public void onScaleChanged( float scale, float previous ) {
    ...
    if(getScaleChangedListener!=null) {
      getScaleChangedListener.getScaleChanged2(scale);
    }
  }
 public getScaleChanged getScaleChangedListener=null;

  public getScaleChanged getGetScaleChangedListener() {
    return getScaleChangedListener;
  }

  public void setGetScaleChangedListener(getScaleChanged getScaleChangedListener) {
    this.getScaleChangedListener = getScaleChangedListener;
  }
 /*
 用于监听scale变化
  */
  public  interface  getScaleChanged{
